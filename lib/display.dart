...
class DisplayProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      EditProfile.routeName: (BuildContext context) => new EditProfile(title: "Edit Profile"),
            ...
            Positioned(
                ...
                child:Column(
                  ...
                  children: <Widget>[
                    ...
                    Text('Jack Frost', style: TextStyle(
                      fontSize: 30.0
                    ),),
                ...
                child: new Column(
                  ...
                  children: <Widget>[
                    new IconButton(
                      ...
                      iconSize: 70.0,
                      onPressed: (){Navigator.of(context).pushNamed("/SuccessPage");},
                    ),
                  ],
                ),
              )
            ,),
              ...
              child: new Center(
                child: new Column(
                  ...
                  children: <Widget>[
                    new IconButton(
                      icon: new Icon(Icons.rate_review, color:Colors.deepOrange),
                      iconSize: 70.0,
                      onPressed: (){Navigator.of(context).pushNamed("/ReviewPage");},
                    ),
                  ],
                ),
        ...
        child: new Center(
           child: new Column(
                  ...
                  children: <Widget>[
                    ...
                    //   onPressed: null,
                    // ),
                    new Text('Complete!', style: TextStyle( fontSize: 30),),
                  ],
                ),
        ),
      ),
...
class ReviewPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("Rate"), backgroundColor: Colors.pinkAccent,
      ),
      body: new Container(
        child: new Center(
           child: new Column(

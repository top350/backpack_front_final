...
class ApiProvider {
  ...
  Future<http.Response> doSignup(String studentid, String firstname,
      String lastname, String password, String phoneNo, String email) async {
  ...
  Future<http.Response> doBorrow(
    ...
    var body = {
      "item_name": itemName,
      "item_type": _selectedCategory,
      "borrow_time": pickupTime,
  ...
  Future<http.Response> doFeedback(
      String feedbackNo, String comment, String taid, String faid) {
